...
class TestPage3updat():
  ...
  def test_page3updat(self):
    self.driver.get("https://webgate.ec.europa.eu/eudamed/secure")
    self.driver.set_window_size(1552, 840)
    self.driver.find_element(By.CSS_SELECTOR, "#device-device-management-link-register-new-UDI-DI > span").click()
    self.driver.execute_script("window.scrollTo(0,487.20001220703125)")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ecl-row:nth-child(4) > .ecl-col > .fieldset-border .eud-u-mr-xs:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ecl-row:nth-child(5) .eud-u-mr-xs:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ecl-row:nth-child(4) > .ecl-col > .fieldset-border .eud-u-mr-xs:nth-child(1)").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ecl-row:nth-child(3) .eud-u-mr-xs:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ecl-row:nth-child(4) .eud-u-mr-xs:nth-child(2) > span").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".radio:nth-child(3) > .eud-u-mr-xs:nth-child(2) > span").click()
